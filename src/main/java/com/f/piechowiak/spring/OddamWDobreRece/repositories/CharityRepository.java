...
public interface CharityRepository extends JpaRepository<Charity, Long> {
    ...
    List<Charity> findAllByIdIn(List<Long> ids);
    List<Charity> findAllByCharityActivityType_IdInAndAcceptedGiftTypesIn(List<Long> ids, List<GiftType> gifts);    //działa!
...
//@TODO Rozszerzyc DonationDto o dane do search baru
